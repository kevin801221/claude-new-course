...
def healthz() -> dict[str, object]:
    ...
    # milestone 從 M1 一路寫到 M5 做完都沒人動過 —— 一個回「M1」的健康檢查，等於叫接手的人
    # 相信 s04–s08 還沒做。這三欄就是現況：跑得完的段、真的能用的 source。
    return {
        "ok": True,
        "contract_v": 1,
        "milestone": "M5",
        "pipeline": "s01-s08",            # s09–s11 仍是 M6/M7，那顆按鈕跑不到
        "sources": ["demo", "roboflow"],  # local 仍然回 501（契約 §8.5）
    }
